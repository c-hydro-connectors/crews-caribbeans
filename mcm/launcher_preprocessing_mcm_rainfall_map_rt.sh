...
#-----------------------------------------------------------------------------------------
# Script information
script_name='LAUNCHER - PREPROCESSING MCM (RAINFALL MAP)'
...
settings_file=/home/silvestro/MSPG/op_chain/preprocessing/mcm/crews_preprocess_mcm_data_rainfall_map.json

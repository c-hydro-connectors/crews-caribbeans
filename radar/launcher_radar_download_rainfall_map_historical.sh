...
#-----------------------------------------------------------------------------------------
# Script information
script_name='LAUNCHER - RADAR RAIN MAP DOWNLOADER'
...
script_file=$script_folder'/radar/crews_import_radar_data_rainfall_map.py'
settings_file=/home/silvestro/MSPG/op_chain/preprocessing/radar/crews_import_radar_data_raifall_map.json
